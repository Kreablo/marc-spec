...
const LETTER_Z = 'Z'.charCodeAt(0);
export const base64RecordAsByteArray = (r) => {
...
export const extractMarcRecordMeta = (b) => {
...
export const extractFields = (b, subscribers) => {
...
export const parseSubfields = (b, meta, entry) => {
...
export const parseField = (b, meta, entry) => {
