import { FieldSpec, IndicatorSpec, AbbrFieldSpec, AbbrIndicatorSpec, AbbrSubfieldSpec, ComparisonString, BinarySubTermSet, BinaryOperator, UnaryOperator } from './marc-spec';
import { ControlField, DataField } from './marc-parser';
...
const fieldData = (fields) => fields.map((f) => f instanceof ControlField
    ? [f.data]
...
export const buildTree = (marcSpec) => {
    const { spec } = marcSpec;
    const subscribers = [];
